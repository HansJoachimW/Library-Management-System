...
@section('content')
    <div class="container mx-auto my-8 text-center">
        <h1 class="text-3xl font-bold mb-4">Welcome to the Library Management System by Hans</h1>
        ...
        <div class="space-x-4">
            ...
            <a href="{{ route('members.index') }}" class="bg-blue-500 text-white px-4 py-2 rounded">Manage Members</a>
        </div>
    </div>
@endsection
